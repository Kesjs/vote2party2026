          ...
          <div className="flex items-center space-x-4">
            {!user ? (
              <>
                ...
                <Link
                  href="/connexion"
                  className="bg-gray-100 text-gray-700 hover:bg-gray-200 px-4 py-2 rounded-lg font-medium transition-colors duration-200"
                >
                  Se connecter
                </Link>
              </>
            ...
            >
              ...
              <nav className="flex-1 overflow-y-auto px-6 pb-8">
                <div className="flex flex-col space-y-2">
                  ...
                  {/* Boutons "Connexion/Compte" en bas du menu mobile */}
                    ...
                    {!user ? (
                      <>
                        ...
                        <Link
                          href="/connexion"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="w-full flex justify-center py-3 bg-gray-100 text-gray-700 rounded-lg text-lg font-medium transition-colors duration-200"
                        >
                          Se connecter
                        </Link>
                      </>
                      ...
                      <>
                        ...
                        <button
                          ...
                          className="w-full flex justify-center py-3 bg-red-50 text-red-600 rounded-lg text-lg font-medium transition-colors duration-200"
                        >
                          Déconnexion
                        </button>
                      </>
